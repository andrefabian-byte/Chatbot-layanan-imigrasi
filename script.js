...
const KB = [
  ...
  { id:'biaya', keywords:'biaya harga bayar tarif ongkos berapa biayanya pembayaran biaya paspor harga paspor',
...
const SUGS=[
    ...
    ['🌐 Beda kantor bisa?','🔒 Paspor mau habis?','📱 Download M-Paspor','💳 Cara bayar?'],
